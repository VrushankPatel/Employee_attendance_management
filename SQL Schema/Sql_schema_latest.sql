create table Administrator(Company_id int NOT NULL auto_increment,Admin_username varchar(255),Admin_Password longtext NOT NULL,PRIMARY KEY(Company_id)) ENGINE=INNODB;
